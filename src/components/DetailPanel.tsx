...
export default function DetailPanel({ pu, onClose }: DetailPanelProps) {
  const [activeTab, setActiveTab] = useState<TabId>("conflict")
  ...
  return (
    <>
      ...
      {/* Bottom sheet */}
      <div className="fixed bottom-0 left-0 right-0 z-[1200] bg-gray-50 rounded-t-3xl shadow-2xl flex flex-col animate-slide-up"
        style={{ height: "85vh" }}
      >
        {/* Handle + header */}
